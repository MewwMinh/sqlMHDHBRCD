...
ngay as(
    ...
    and a.chuyen_phieu not in (1, 2, 4) and a.trang_thai_bh <> 6 and a.hen_sua_tu is not null and a.ngay_ht is null
...
select 
    'KPI_12.1' as ma_kpi, 
    'Số phiếu tồn KPSC chưa xử lý (có hẹn)' as kpi_name,
